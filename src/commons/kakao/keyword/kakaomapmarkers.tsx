        ...
        <>
          {marker.group_code === "FD6" && (
            <S.KakaoMapMarker
              ...
              image={{
                src: "https://img.icons8.com/external-nawicon-outline-color-nawicon/64/000000/external-restaurant-location-nawicon-outline-color-nawicon.png",
          ...
          {marker.group_code === "MT1" && (
            <S.KakaoMapMarker
              ...
              onClick={props.markerClick(marker)}
              image={{
                src: "https://img.icons8.com/external-nawicon-outline-color-nawicon/64/000000/external-supermarket-location-nawicon-outline-color-nawicon.png",
                size: { width: 40, height: 40 },
              }}
            >
              {props.info &&
          ...
          {marker.group_code === "CE7" && (
            <S.KakaoMapMarker
              ...
              onClick={props.markerClick(marker)}
              image={{
                src: "https://img.icons8.com/external-nawicon-outline-color-nawicon/64/000000/external-coffee-shop-location-nawicon-outline-color-nawicon.png",
                size: { width: 40, height: 40 },
              }}
            >
              {props.info &&
